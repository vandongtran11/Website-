    ...
    <div class="card-body">
      ...
      <p class="card-text" style="text-align:center">Đổi hàng thoải mái trong 30 ngày</p>
            ...
            <div class="container">
             ...
             <div class="row" style="margin-top:25px">            
				<h1 style="text-align:center; width:100%" id="nike">ÁO POLO MỚI NHẤT</h1>
                    <div class="col-sm-12">
              ...
              <div class="row" style="margin-top:25px">            
				<h1 style="text-align:center; width:100%" id="adidas">QUẦN JEAN MỚI NHẤT</h1>
                    <div class="col-sm-12">
        ...
        <script>
        	 ...
        	 function loadMoreAdidas() {
                 ...
                 $.ajax({
                     url: "/WebsiteThoiTrang/loadAdidas",
                     type: "get", //send it through get method
                     data: {
             ...
             function searchByName(param){
                 ...
                 $.ajax({
                     url: "/WebsiteThoiTrang/searchAjax",
                     type: "get", //send it through get method
                     data: {
                         txt: txtSearch
                     },
